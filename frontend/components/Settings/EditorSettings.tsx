  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            <label htmlFor="editor-wrap" className="text-sm font-medium text-foreground cursor-pointer">
              Word Wrap
            </label>
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            <label htmlFor="editor-line-numbers" className="text-sm font-medium text-foreground cursor-pointer">
              Line Numbers
            </label>
            <p className="text-xs text-muted-foreground">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            <label htmlFor="editor-relative-line-numbers" className={`text-sm font-medium cursor-pointer ${!lineNumbers ? "text-muted-foreground" : "text-foreground"}`}>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            <label htmlFor="editor-vim-mode" className="text-sm font-medium text-foreground cursor-pointer">
              Enable Vim Mode
            </label>
            <p className="text-xs text-muted-foreground">
              Use Vim keybindings for editing
            </p>
          </div>
          <Switch
            id="editor-vim-mode"
