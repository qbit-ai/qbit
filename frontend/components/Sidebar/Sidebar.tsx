...
export function Sidebar({ workingDirectory, onFileSelect, isOpen, onToggle }: SidebarProps) {
  ...
  return (
    <div
      ref={sidebarRef}
      className="h-full bg-sidebar border-r border-sidebar-border flex flex-col overflow-hidden relative"
      ...
      <div className="px-2 py-2 border-b border-sidebar-border">
        <div className="relative">
          ...
          <Input
            ...
            className="h-7 pl-7 text-sm bg-[#1f2335] border-border text-[#c0caf5] placeholder:text-[#565f89]"
          />
        </div>
      </div>
